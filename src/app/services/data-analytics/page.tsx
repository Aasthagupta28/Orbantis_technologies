        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-poppins font-bold text-white mb-6">
              Ready to Transform Your Data into <span className="bg-gradient-to-r from-cyan-400 to-white bg-clip-text text-transparent">Actionable Insights?</span>
            </h2>
            <p className="text-xl text-gray-200 mb-8 max-w-3xl mx-auto leading-relaxed">
              Let's discuss your data requirements and create comprehensive solutions that 
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                ...
                className="inline-flex items-center bg-white text-indigo-600 px-8 py-4 rounded-full font-semibold hover:bg-gray-100 transition-all duration-300 hover:scale-105"
              >
                <span>Start Your Data Project</span>
                <ArrowRight className="w-5 h-5 ml-2" />
              </Link>
              <Link
